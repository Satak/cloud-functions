...
if(!$token) {
    ...
    gcloud beta functions deploy test --entry-point main --runtime python37 --trigger-http --project "$Project" --region europe-west1 --set-env-vars TOKEN="$token" --source ./src
}
